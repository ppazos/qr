 ...
 * @version $Revision: 10691 $ $Date: 2009-04-06 09:16:14 +0200 (Mon, 06 Apr 2009) $
 * @since Jan, 2006
 */
public class QRLifecycle2 {
    private static Logger LOG = LoggerFactory.getLogger(QRLifecycle2.class);
...
//        System.out.println(xml);
        ...
        QRLifecycle2 dcmqr = new QRLifecycle2();
...
//                    System.out.println( "  <objeto>" );
                    ...
                    tags.put("Study Instance UID TAG", Integer.parseInt("0020000D",16));
                    tags.put("Series Instance UID TAG", Integer.parseInt("0020000E",16));
                    tags.put("SOP Instance UID TAG", Integer.parseInt("00080018",16));
                    
                    // TAG esta en decimal, quiero poder accederlo por la tag definida en hexa,
                    // para la ocnversion>
                    /*
                    int studyInstanceUIDTag = Integer.parseInt("0020000D",16);
                    int seriesInstanceUIDTag = Integer.parseInt("0020000E",16);
                    int sopInstanceUIDTag = Integer.parseInt("00080018",16);
                    
                    int studyIDTag = Integer.parseInt("00200010",16);
                    
                    int numberOfStudyRelatedSeriesTag = Integer.parseInt("00201206",16);
                    int numberOfStudyRelatedInstancesTag = Integer.parseInt("00201208",16);
                    
                    int studyDateTag = Integer.parseInt("00080020",16);
                    int studyTimeTag = Integer.parseInt("00080030",16);
                    
                    int modalitiesInStudyTag = Integer.parseInt("00080061",16);
                    */
...
//               System.out.println( "</result>" );
    ...
    private final DimseRSPHandler rspHandler = new DimseRSPHandler() {
        ...
        public void onDimseRSP(Association as, DicomObject cmd,
                DicomObject data) {
            QRLifecycle2.this.onMoveRSP(as, cmd, data);
        }
    };
    ...
    private static InputStream openFileOrURL(String url) throws IOException {
        if (url.startsWith("resource:")) {
            return QRLifecycle2.class.getClassLoader().getResourceAsStream(
                    url.substring(9));
        }
        try {
